...
export default function Navbar({ onLoginWithX, onLoginWithTumblr }) {
  return (
    <nav className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white p-4 flex justify-between items-center shadow-lg">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="flex items-center gap-2 bg-white text-purple-600 font-semibold px-4 py-2 rounded-full hover:bg-gray-100 transition transform hover:-translate-y-1 shadow-lg">
